...
class FirstPartyPrincipal(BaseModel):
    principalEmail: Optional[str] = Field(
        None, description='The email address of a Google account. .'
    )
    serviceMetadata: Optional[Dict[str, Any]] = Field(
        None, description='Metadata about the service that uses the service account. .'
    )


class Peer(BaseModel):
    ip: Optional[str] = Field(None, description='The IP address of the peer.')
    labels: Optional[Dict[str, str]] = Field(
        None, description='The labels associated with the peer.'
    )
    port: Optional[str] = Field(None, description='The network port of the peer.')
    principal: Optional[str] = Field(
        None,
...
class Request(BaseModel):
    ...
    host: Optional[str] = Field(
        None, description='The HTTP request `Host` header value.'
    )
    ...
    method: Optional[str] = Field(
        None, description='The HTTP request method, such as `GET`, `POST`.'
    )
    path: Optional[str] = Field(
        None, description='The HTTP URL path, excluding the query parameters.'
    )
    protocol: Optional[str] = Field(
        None,
    ...
    scheme: Optional[str] = Field(
        None, description='The HTTP URL scheme, such as `http` and `https`.'
    )
    size: Optional[str] = Field(
        None, description='The HTTP request size in bytes. If unknown, it must be -1.'
    )
...
class RequestMetadata(BaseModel):
    ...
    destinationAttributes: Optional[Peer] = Field(
        None,
    ...
    requestAttributes: Optional[Request] = Field(
        None,
...
class ResourceInfo(BaseModel):
    ...
    name: Optional[str] = Field(
        None, description='The name of the resource referenced in the request.'
    )
    ...
    type: Optional[str] = Field(
        None, description='The resource type in the format of "{service}/{kind}".'
    )


class ResourceLocation(BaseModel):
    currentLocations: Optional[List[str]] = Field(
        None,
    ...
    originalLocations: Optional[List[str]] = Field(
        None,
...
class Response(BaseModel):
    backendLatency: Optional[str] = Field(
        None,
    ...
    code: Optional[str] = Field(
        None, description='The HTTP response status code, such as `200` and `404`.'
    )
    headers: Optional[Dict[str, str]] = Field(
        None,
    ...
    size: Optional[str] = Field(
        None, description='The HTTP response size in bytes. If unknown, it must be -1.'
    )
    time: Optional[str] = Field(
        None,
...
class ThirdPartyPrincipal(BaseModel):
    thirdPartyClaims: Optional[Dict[str, Any]] = Field(
        None, description='Metadata about third party identity.'
    )


class V2HttpRequest(BaseModel):
...
class V2LogEntryOperation(BaseModel):
...
class V2LogEntrySourceLocation(BaseModel):
...
class ViolationInfo(BaseModel):
    checkedValue: Optional[str] = Field(
        None,
    ...
    constraint: Optional[str] = Field(None, description='Optional. Constraint name')
    errorMessage: Optional[str] = Field(
        None, description='Optional. Error message that policy is indicating.'
    )
    policyType: Optional[PolicyType] = Field(
        None, description='Optional. Indicates the type of the policy.'
    )
...
class AttributeContext(BaseModel):
    ...
    destination: Optional[Peer] = Field(
        None,
    ...
    request: Optional[Request] = Field(
        None, description='Represents a network request, such as an HTTP request.'
    )
    ...
    response: Optional[Response] = Field(
        None, description='Represents a network response, such as an HTTP response.'
    )
    source: Optional[Peer] = Field(
        None,
...
class AuthorizationInfo(BaseModel):
    ...
    permission: Optional[str] = Field(None, description='The required IAM permission.')
    ...
    resourceAttributes: Optional[Resource] = Field(
        None,
...
class CheckRequest(BaseModel):
    attributes: Optional[AttributeContext] = Field(
        None,
        description='Describes attributes about the operation being executed by the service.',
    )
    flags: Optional[str] = Field(
        None, description='Optional. Contains a comma-separated list of flags.'
    )
    resources: Optional[List[ResourceInfo]] = Field(
        None,
...
class OrgPolicyViolationInfo(BaseModel):
    ...
    violationInfo: Optional[List[ViolationInfo]] = Field(
        None, description='Optional. Policy violations'
    )


class PolicyViolationInfo(BaseModel):
    orgPolicyViolationInfo: Optional[OrgPolicyViolationInfo] = Field(
        None, description='Indicates the orgpolicy violations for this resource.'
    )


class ReportRequest(BaseModel):
    operations: Optional[List[AttributeContext]] = Field(
        None,
...
class ServiceAccountDelegationInfo(BaseModel):
    firstPartyPrincipal: Optional[FirstPartyPrincipal] = Field(
        None, description='First party (Google) identity as the real authority.'
    )
    ...
    thirdPartyPrincipal: Optional[ThirdPartyPrincipal] = Field(
        None, description='Third party identity as the real authority.'
    )


class V2LogEntry(BaseModel):
    httpRequest: Optional[V2HttpRequest] = Field(
        None,
    ...
    monitoredResourceLabels: Optional[Dict[str, str]] = Field(
        None,
    ...
    operation: Optional[V2LogEntryOperation] = Field(
        None,
    ...
    sourceLocation: Optional[V2LogEntrySourceLocation] = Field(
        None,
        description='Optional. Source code location information associated with the log entry, if any.',
    )
    structPayload: Optional[Dict[str, Any]] = Field(
        None,
...
class AuthenticationInfo(BaseModel):
    authoritySelector: Optional[str] = Field(
        None,
    ...
    thirdPartyPrincipal: Optional[Dict[str, Any]] = Field(
        None,
...
class AuditLog(BaseModel):
    authenticationInfo: Optional[AuthenticationInfo] = Field(
        None, description='Authentication information.'
    )
    authorizationInfo: Optional[List[AuthorizationInfo]] = Field(
        None,
    ...
    numResponseItems: Optional[str] = Field(
        None,
        description='The number of items returned from a List or Query API method, if applicable.',
    )
    policyViolationInfo: Optional[PolicyViolationInfo] = Field(
        None,
    ...
    requestMetadata: Optional[RequestMetadata] = Field(
        None, description='Metadata about the operation.'
    )
    resourceLocation: Optional[ResourceLocation] = Field(
        None, description='The resource location information.'
    )
    ...
    resourceOriginalState: Optional[Dict[str, Any]] = Field(
        None,
    ...
    status: Optional[Status] = Field(
        None, description='The status of the overall operation.'
    )
